...
`run_restamp_derivation` (`canon_validate.py:2859-2899`) re-records the CURRENT `particle_config_hash` /
...
unconditionally (`canon_validate.py:2691-2710`, "a merge that changes nothing no longer moves
