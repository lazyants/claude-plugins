...
const EXPECTED_UNRESOLVED = [
  ...
  { file: 'references/publish-targets/obsidian-vault.md', offset: 27919, quotedText: 'Non-headings index', direction: 'below' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 40456, quotedText: 'INDEX wiring', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 42165, quotedText: 'INDEX wiring', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 46424, quotedText: 'INDEX wiring', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 51651, quotedText: 'INDEX wiring', direction: 'above' },
  ...
  { file: 'references/publish-targets/static-md.md', offset: 28367, quotedText: "Grouped entry, line present, `indexForm: 'headings'`", direction: 'above' },
  { file: 'references/publish-targets/static-md.md', offset: 33146, quotedText: 'Grouped index wiring', direction: 'above' },
  { file: 'references/publish-targets/static-md.md', offset: 34863, quotedText: 'Grouped index wiring', direction: 'above' },
  { file: 'references/publish-targets/static-md.md', offset: 43356, quotedText: 'Grouped index wiring', direction: 'above' },
];
