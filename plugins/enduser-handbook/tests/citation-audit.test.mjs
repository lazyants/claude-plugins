...
// quoted in the plan.
const EXPECTED_TOTAL_CITATIONS = 68;
...
const EXPECTED_UNRESOLVED = [
  ...
  { file: 'references/publish-targets/obsidian-vault.md', offset: 27150, quotedText: 'Non-headings index, no existing line', direction: 'below' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 28521, quotedText: 'Non-headings index', direction: 'below' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 31750, quotedText: 'The placement check is retained unchanged (D-8)', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 42201, quotedText: 'Container resolution', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 45544, quotedText: 'INDEX wiring', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 47301, quotedText: 'INDEX wiring', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 51560, quotedText: 'INDEX wiring', direction: 'above' },
  { file: 'references/publish-targets/obsidian-vault.md', offset: 56787, quotedText: 'INDEX wiring', direction: 'above' },
  ...
  { file: 'references/publish-targets/static-md.md', offset: 29433, quotedText: 'Grouped index wiring', direction: 'above' },
  { file: 'references/publish-targets/static-md.md', offset: 30937, quotedText: "Grouped entry, line present, `indexForm: 'headings'`", direction: 'above' },
  { file: 'references/publish-targets/static-md.md', offset: 35356, quotedText: 'Grouped index wiring', direction: 'above' },
  { file: 'references/publish-targets/static-md.md', offset: 37064, quotedText: 'Grouped index wiring', direction: 'above' },
  { file: 'references/publish-targets/static-md.md', offset: 45557, quotedText: 'Grouped index wiring', direction: 'above' },
];
