...
# (segment_dispatch_driver.py:7955's `claims=claims`) actually carry a REAL
...
def test_a_real_selector_claim_reaches_process_segment_through_the_real_run_wiring(tmp_path):
    ...
    construction at segment_dispatch_driver.py:7955 leaves all eleven of
...
def test_a_real_selector_from_stalled_claim_reaches_process_segment_through_the_real_run_wiring(tmp_path):
    ...
    selector (segment_dispatch_driver.py:1782-1820) -- both real here, not
