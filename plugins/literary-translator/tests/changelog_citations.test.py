...
CITATION_ANCHORS = {
    ...
    # matches.
    #
    # The 1.105.0 rotation this replaces, kept as its own record (#888 -- name discovery asked an uncased-script model
    ...
    # file has no version pin to notice a skipped rotation. That release is
    # preserved in this file's history; the record below is the one this
    # replaces.
    #
    # The 1.96.0 rotation this replaces, kept as its own record (#876 -- the
    # glossary run's merge marker says its dispatch model is unrecorded), and
    # EMPTY ON PURPOSE, for the same
