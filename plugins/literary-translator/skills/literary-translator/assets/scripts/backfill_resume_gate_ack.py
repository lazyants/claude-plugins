...
try:
    ...
    sys.exit(
        f"backfill_resume_gate_ack.py: cannot load json_stdout.py from {_JSON_STDOUT_PATH} "
        f"({_json_stdout_exc}).\n"
        "json_stdout.py must be installed alongside backfill_resume_gate_ack.py under "
