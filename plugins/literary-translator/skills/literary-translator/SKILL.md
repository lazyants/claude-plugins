...
the review file: the claim record keeps the `cache_key` as it stood when you
claimed, and only a completed convergence rewrites that. Finish the
re-review; never delete the claim record, which is the sole durable account
of the void (`#773`).
