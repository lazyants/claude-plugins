...
- 446 unit tests across the plugin's suite (`plugins/enduser-handbook/tests/*.test.mjs`), of which the #220/#221 changes in `chapter-paths.test.mjs` account for 152; 321 documentation assertions.
